...
pygame.init()       #it will initialize all pygame modules

screen = pygame.display.set_mode((screen_width, screen_height))         #setting screen size
pygame.display.set_caption('Analogue Clock')     #window title
...
while True:
    ...
    arc((screen_width // 2, screen_height // 2), 180, 0, s * 6, 3, (255,165,0))
    arc((screen_width // 2, screen_height // 2), 170, 0, m * 6, 3, (255, 255, 255))
    arc((screen_width // 2, screen_height // 2), 160, 0, h * 30, 3, (0,128,0))
    clock_hand((screen_width // 2, screen_height // 2), 140, s * 6, 5, (255, 255, 255))
    clock_hand((screen_width // 2, screen_height // 2), 120, m * 6, 5, (255, 255, 255))
    clock_hand((screen_width // 2, screen_height // 2), 100, h * 30, 5, (255, 255, 255))
